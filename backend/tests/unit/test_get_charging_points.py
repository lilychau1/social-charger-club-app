...
from get_charging_points.app import lambda_handler, get_lat_long_from_postcode

@pytest.fixture
def mock_dynamodb_table():
    with patch('get_charging_points.app.table') as mock_table:
...
@pytest.fixture
def mock_geocoder():
    with patch('get_charging_points.app.Nominatim') as mock_nom:
...
# @patch('get_charging_points.app.table')
